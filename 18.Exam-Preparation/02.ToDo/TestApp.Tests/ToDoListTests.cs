...
public class ToDoListTests
{
    ...
    //преди всеки един тест => създава един нов празен todolist, който се съхранява в _toDoList
    ...
    public void Test_AddTask_TaskAddedToToDoList()
    {
        ...
        DateTime dueDate = DateTime.Now.AddDays(2); //2 дни след днес -> 16.08
    ...
    {
        //Arrange
        string title = "Go shopping"; //заглавие на задача
        DateTime dueDate = DateTime.Now.AddDays(2); //краен срок: 2 дни след днес -> 16.08
        _toDoList.AddTask(title, dueDate);
    ...
    {
        //Arrange
        //_toDoList -> имаме празен списък без задачи в него
